...
CREATE INDEX IF NOT EXISTS idx_teacher_faculties_teacher_id ON teacher_faculties (teacher_id);
CREATE INDEX IF NOT EXISTS idx_teacher_faculties_faculty_id ON teacher_faculties (faculty_id);
